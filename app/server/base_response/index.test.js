...
describe('Base responses', function () {
  describe('Base error response', function () {
    ...
    it('It should return object with field success = false', function (done) {
      expect(baseError('Test').success).toBeFalsy();
      done()
    });
    it('It should return object with field messageType = error', function (done) {
      expect(baseError('Test').messageType).toEqual('error');
      done();
    });
    it('It should return object with field data equal to null', function (done) {
      expect(baseError('Test').data).toBeNull();
      done();
    });
    it('It should return object with given messageBody', function (done) {
      expect(baseError('Test').messageBody).toEqual('Test');
      done();
    });
    it('It should return object with default messageBody, if messageBody not specified', function (done) {
  ...
  describe('Base warning response', function () {
    ...
    it('It should return object with field messageType = warning', function (done) {
  ...
  describe('Base success response', function () {
    ...
    it('It should throw error, if data not specified', function (done) {
      expect(function() {baseSuccess('Test')}).toThrow();
      done();
    });
    it('It should return object with field success = true', function (done) {
      expect(baseSuccess('Test', 'Test').success).toBeTruthy();
      done();
    });
    it('It should return object with field messageType = success', function (done) {
      expect(baseSuccess('Test', 'Test').messageType).toEqual('success');
      done();
    });
    it('It should return object with given data', function (done) {
